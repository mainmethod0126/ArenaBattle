...
void UBTService_Detect::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMoemory, float DeltaSeconds)
{
	Super::TickNode(OwnerComp, NodeMoemory, DeltaSeconds);
